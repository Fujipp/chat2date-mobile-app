...
-- Fri Oct 10 14:39:06 2025
-- Model: New Model    Version: 1.0
-- MySQL Workbench Forward Engineering

SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0;
SET @OLactiontableactiontableD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0;
...
-- -----------------------------------------------------
-- Table `chat2date`.`actiontable`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chat2date`.`actiontable` (
...
-- -----------------------------------------------------
-- Table `chat2date`.`matchtable`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `chat2date`.`matchtable` (
...
CREATE TABLE IF NOT EXISTS `chat2date`.`preferencematch` (
  ...
  `interestedGender` ENUM('SAME', 'NEARLY', 'OPPOSITE', 'UNNECESSALY') NOT NULL,
  `interestedTravelStyle` ENUM('SAME', 'NEARLY', 'OPPOSITE', 'UNNECESSALY') NOT NULL,
  `interestedLifeStyle` ENUM('SAME', 'NEARLY', 'OPPOSITE', 'UNNECESSALY') NOT NULL,
  `interestedInterest` ENUM('SAME', 'NEARLY', 'OPPOSITE', 'UNNECESSALY') NOT NULL,
