...
public class GeminiClient {
    ...
    public String generateQuestions(String chatLog) {
        ...
        return """
            [
                {
                    "text": "Person A ชอบกินอาหารประเภทไหนมากที่สุด?",
                    "options": ["อาหารญี่ปุ่น", "อาหารไทย", "อาหารอิตาเลียน", "อาหารเกาหลี"],
                    "correct": "อาหารญี่ปุ่น"
                },
                {
                    "text": "Person B เลี้ยงสัตว์อะไรไว้ที่บ้าน?",
                    "options": ["สุนัข", "แมว", "นก", "ปลา"],
                    "correct": "แมว"
                },
                {
                    "text": "ทั้งคู่เคยคุยกันเรื่องภาพยนตร์แนวไหน?",
                    "options": ["Action", "Romance", "Horror", "Comedy"],
                    "correct": "Horror"
                },
                {
                    "text": "สถานที่ที่ Person A อยากไปเที่ยวคือที่ไหน?",
                    "options": ["เชียงใหม่", "ภูเก็ต", "ญี่ปุ่น", "เกาหลี"],
                    "correct": "ญี่ปุ่น"
                },
                {
                    "text": "Person B ชอบทำกิจกรรมอะไรในเวลาว่าง?",
