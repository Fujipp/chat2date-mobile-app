...
/// Figma: Color-Button (16 variables)
abstract final class ButtonColors {
  ...
  static const Color acceptHover     = Color(0xFF36FF65); // Figma: Accept-Hover
  static const Color acceptActive    = Color(0xFF00FF3B); // Figma: Accept-Active

  static const Color denied          = Color(0xFFFF6B6B); // Figma: Denied
  static const Color deniedDisabled  = Color(0xFFFFADAD); // Figma: Denied-Disabled
  static const Color deniedHover     = Color(0xFFC83838); // Figma: Denied-Hover
  static const Color deniedActive    = Color(0xFFFF0000); // Figma: Denied-Active
}
