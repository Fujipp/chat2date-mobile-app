...
class _PolicyPageState extends State<PolicyPage> {
  ...
  bool _unlocked = false; // ปลดล็อกช่องติ๊กเมื่อเลื่อนถึงท้ายอย่างน้อย 1 ครั้ง
    ...
    _scrollCtrl = ScrollController()
      ..addListener(() {
        ...
        if (pos.pixels >= (pos.maxScrollExtent - 8.0)) {
          setState(() => _unlocked = true); // ปลดล็อกครั้งเดียวพอ
        }
      });
  }
              ...
              child: Stack(
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                      height:
                          600, // เดิมเท่าเดิม; จะให้ยืดตามจอก็เปลี่ยนเป็น MediaQuery สูงสุด
                          ...
                          Expanded(
                            child: SingleChildScrollView(
                              ...
                              child: const Text(
                                ...
                                '4. การใช้งานฟีเจอร์เกมทายใจและการประมวลผลข้อมูลด้วย AI\n'
                                '4.1 การเข้าถึงประวัติการสนทนา ผู้ใช้งานรับทราบและยินยอมให้ระบบนำประวัติการสนทนา (Chat History) '
                                'บางส่วน ไปประมวลผลผ่านระบบปัญญาประดิษฐ์ (Generative AI) เพื่อวัตถุประสงค์ในการสร้างคำถามและเนื้อหาสำหรับเกมทายใจเท่านั้น\n'
                                '4.2 การคุ้มครองข้อมูลและความถูกต้อง ระบบจะทำการปกปิดข้อมูลระบุตัวตน (Anonymization) ก่อนการประมวลผล '
                                'และจะไม่มีการนำเนื้อหาแชทไปเผยแพร่ต่อสาธารณะ เนื้อหาเกมที่สร้างโดย AI อาจมีความคลาดเคลื่อน '
                                'ผู้ใช้งานตกลงว่าเป็นเพียงกิจกรรมเพื่อความบันเทิงและกระชับความสัมพันธ์',
