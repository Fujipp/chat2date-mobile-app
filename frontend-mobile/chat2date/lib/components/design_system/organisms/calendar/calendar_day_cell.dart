...
class CalendarDayCell extends StatelessWidget {
  ...
  const CalendarDayCell({
    ...
    this.selectedTextColor = AppColors.textOnDark,
  ...
  Widget build(BuildContext context) {
    ...
    final textNormal = textBase.copyWith(color: AppColors.textPrimary);
    ...
    if (_isSelected) {
      if (selectedDisabled) {
        return Container(
          ...
          child: Text(
            dayStr,
            style: textDisabled.copyWith(fontWeight: FontWeight.w700),
